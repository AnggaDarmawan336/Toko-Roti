...
<html lang="en">
  <head>
    ...
    <title>Toko Roti Baru</title>
  </head>
  <body>
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">TOKO ROTI BARU</span></h1>
          <hr>
          <p class="lead font-weight-bold">Silahkan Pesan Sesuai Keinginan Anda <br> 
          Bread Gonna Talk</p>
        </div>
      </div>
  <!-- Akhir Jumbotron -->
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>Toko</strong> Roti Baru</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link mr-4" href="list_user.php">LIST USER</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->
    <div class="container">
      ...
      <button type="button" class="btn btn-info hide" onclick="window.print()">Print Laporan</button>
    </div>
  <!-- Akhir Menu -->
