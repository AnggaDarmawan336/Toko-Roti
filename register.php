...
<html lang="en">
 ...
 <!-- Form Registrasi -->
  <div class="container">
    ...
    <form method="POST" action="simpan_register.php" onsubmit="return cekformregister()">
      <div class="form-row">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-2">
          ...
          <input type="text" class="form-control" id="hp" name="hp" placeholder="No. Telephone">
        </div>
      </div>     
      <button type="register" class="btn btn-primary">Register</button>
      <button type="reset" class="btn btn-danger">Reset</button>
      <button type="reset" class="btn btn-danger" name="kembali" onclick="window.location.href='index.php'">Kembali</button>
    </form>
  </div>
  </div>
