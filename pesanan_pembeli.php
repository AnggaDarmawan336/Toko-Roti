...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>Toko</strong> Roti Baru</a>
    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
            ...
            <?php 
              include('koneksi.php');
              $ambil = mysqli_query($koneksi, "SELECT a.id_user, a.nama_lengkap, b.nama_menu, b.harga FROM user a, produk b WHERE id_menu='$id_menu'");
