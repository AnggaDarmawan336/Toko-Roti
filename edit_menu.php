 ...
 <!-- Form Registrasi -->
  <div class="container">
    ...
    <div class="card p-5 mb-5">
      <form method="POST" action="edit.php" enctype="multipart/form-data" onsubmit="return cekformtambah()">
        <div class="form-group">
          <label for="menu1">Nama Menu</label>
          <input type="hidden" name="id_menu" value="<?php echo $result[0]['id_menu'] ?>">
          <input type="text" class="form-control" id="nama_menu" name="nama_menu" value="<?php echo $result[0]['nama_menu'] ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="stok" name="stok" value="<?php echo $result[0]['stok'] ?>">
        </div>
        <div class="form-group">
        ...
        <button type="reset" class="btn btn-danger" name="kembali" onclick="window.location.href='daftar_menu.php'">Kembali</button>
  </div>
  </div>
